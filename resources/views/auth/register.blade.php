...
<body>
    <div id="app" style="">
        <main class="py-4 main">
            <!-- <div class="container" style="position: absolute;top: 5%; left: 15%;">
                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ route('store-user-information') }}">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            <input id="fname" type="text" class="form-control @error('name') is-invalid @enderror" name="fname" required autocomplete="first-name" autofocus>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            <input id="mname" type="text" class="form-control @error('name') is-invalid @enderror" name="mname" required autocomplete="middle-name" autofocus>
                                    ...
                                    <div class="row mb-0">
                                        <div class="col-md-6 offset-md-4" style="margin-left: 40%;">
                                            ...
                                            <button type="button" class="btn btn-primary" onclick="window.location='{{ url("login") }}'">
                                                Back
                                            </button>
                                        </div>
                                    </div>
